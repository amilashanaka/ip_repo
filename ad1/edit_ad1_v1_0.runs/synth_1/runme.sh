...
HD_PWD='C:/Projects/ERN24004/IP/ip_repo/ad1/edit_ad1_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ad1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ad1.tcl
