...
`timescale 1 ns / 1 ps
	...
	module adc_dma_master_lite_v1_0_M00_AXI #
	(
	...
	(
        ...
        // System Signals
        input wire INIT_AXI_TXN,           // Start AXI transactions
        output reg ERROR,                  // Asserted on error
        output wire TXN_DONE,              // Asserted when AXI transaction is complete
        input wire M_AXI_ACLK,             // AXI clock
        input wire M_AXI_ARESETN,          // AXI active-low reset
        ...
        output wire [C_M_AXI_DATA_WIDTH/8-1 : 0] M_AXI_WSTRB, // Write strobe
